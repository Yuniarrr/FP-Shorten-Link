<template>
  <div class="w-full ml-24 mr-5 mb-9 my-7 rounded-lg bg-neutral-900 px-7 py-6 h-fit">
    ...
    <div class="mt-8 space-y-3">
      <div class="bg-neutral-800 rounded-lg w-2/3 flex items-center mb-9">
        <input
          ...
          name="url"
          id="url"
          class="rounded-lg w-full bg-neutral-800 border-0 focus:outline-none focus:ring-0"
      ...
      <div class="p-5 bg-neutral-800 rounded-lg w-2/3">
        <div class="flex relative">
          <h1 class="font-medium text-2xl hover:underline text-yellow-200 cursor-pointer">
            S.it/B3uz4
          </h1>
          <Icon
            icon="carbon:copy"
        ...
        <a href="#" class="text-neutral-400 hover:underline">https://router.vuejs.org/</a>
        <hr class="mt-1" />
        <div class="w-full relative flex mt-2">
          ...
          <div class="absolute right-0">
            <div class="flex items-center space-x-2">
              <div
                class="bg-neutral-700 p-1 h-7 rounded-md cursor-pointer hover:bg-neutral-600"
              >
                <Icon
